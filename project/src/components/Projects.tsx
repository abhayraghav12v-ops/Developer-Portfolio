...
const projects: Project[] = [
  {
    ...
    description:
      'A full-stack blogging platform built using MongoDB, Express.js, React.js, and Node.js. The application allows users to create, edit, and manage blog posts. It includes secure JWT authentication, comments, likes, image uploads using Cloudinary, and an admin management system.',
    image:
      'https://images.pexels.com/photos/10894404/pexels-photo-10894404.jpeg?auto=compress&cs=tinysrgb&w=800',
    technologies: [
      'React.js',
      'Node.js',
      'Express.js',
  ...
  },
  {
    ...
    description:
      'An e-commerce web application with product browsing, cart management, checkout functionality, and an admin portal for managing products.',
    image:
      'https://images.pexels.com/photos/10894404/pexels-photo-10894404.jpeg?auto=compress&cs=tinysrgb&w=800',
  ...
  },
  {
    title: 'Chatterly',
    description:
      'A modern communication application developed as a team project. I contributed as a UI Designer and worked on creating a clean and user-friendly interface. The platform focuses on secure communication and includes end-to-end encryption concepts.',
    image:
      'https://images.pexels.com/photos/10894404/pexels-photo-10894404.jpeg?auto=compress&cs=tinysrgb&w=800',
...
export default function Projects() {
  ...
  return (
    <section id="projects" className="relative py-24 bg-dark-800">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              ...
              >
                ...
                {/* Glow Effect */}
                <motion.div className="absolute -inset-1 bg-gradient-to-r from-primary-500/0 via-primary-500/0 to-accent-purple/0 rounded-3xl group-hover:from-primary-500/20 group-hover:via-transparent group-hover:to-accent-purple/20 blur-xl transition-all duration-500 -z-10 opacity-0 group-hover:opacity-100" />
              </motion.div>
            ))}
          </div>
